...
export default function StaffTab() {
  ...
  return (
    <section>
      <h2 className="text-lg font-bold mb-3.5">Staff &amp; Salary</h2>
      ...
      <TableScroll>
        <DataTable columns={['Name', 'Role', 'Monthly Salary', 'Total Due (till date)', 'Total Paid', 'Balance', 'Actions']}>
          {staff.length === 0 && <EmptyRow span={7}>Koi staff add nahi kiya abhi.</EmptyRow>}
          {staff.map((s) => {
